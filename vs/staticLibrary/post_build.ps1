...
# headers
$TargetDir = "$OutputDir\DERemoteLauncherSDK\DERemoteLauncherSDK\Include\deremotelauncher"
...
# library
$TargetDir = "$OutputDir\DERemoteLauncherSDK\DERemoteLauncherSDK\Library\x64"
...
# info
$TargetDir = "$OutputDir\DERemoteLauncherSDK\DERemoteLauncherSDK"
