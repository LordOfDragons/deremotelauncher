...
# headers
$TargetDir = "$OutputDir\DERemoteLauncherSDK\Include\deremotelauncher"
...
# library
$TargetDir = "$OutputDir\DERemoteLauncherSDK\Library\x64"
...
# info
$TargetDir = "$OutputDir\DERemoteLauncherSDK"
